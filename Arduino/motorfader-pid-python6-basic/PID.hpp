...
class PID {
  public:
    PID(float k_p, float k_i, float k_d, float Ts) : k_p(k_p), k_i(k_i), k_d(k_d), Ts(Ts) {}
    ...
    void setProp(float k_p) {
      this->k_p = k_p;
    }
    void setInt(float k_i) {
      this->k_i = k_i;
    }
    void setDeriv(float k_d) {
      this->k_d = k_d;
    }
